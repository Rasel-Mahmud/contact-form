...
function twentytwenty_register_scripts()
{
    ...
    // Form JS
    wp_enqueue_script('form-js', get_template_directory_uri() . '/assets/js/form.js', array('jquery'), time(), false);
    wp_localize_script(
        'form-js',
        'formBuilder',
        array(
        'ajaxurl' => admin_url('admin-ajax.php'),
        'thank_you_page' => 'http://form-builder.test/thank-you',
        )
    );
}
...
// Form Builder
add_action('wp_ajax_sendMailData', 'contact_form');
add_action('wp_ajax_nopriv_sendMailData', 'contact_form');
